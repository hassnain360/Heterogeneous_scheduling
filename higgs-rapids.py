...
X_train, X_test, y_train, y_test = cu_train_test_split(X, y, test_size = 1000000)sss
...
higgs1 = cudf.read_csv('./datasets/higgs1.csv').iloc[:,1:30].astype('float32')
higgs100 = cudf.read_csv('./datasets/higgs100.csv').iloc[:,1:30].astype('float32')
higgs1K = cudf.read_csv('./datasets/higgs1K.csv').iloc[:,1:30].astype('float32')
higgs10K = cudf.read_csv('./datasets/higgs10K.csv').iloc[:,1:30].astype('float32')
higgs100K = cudf.read_csv('./datasets/higgs100K.csv').iloc[:,1:30].astype('float32')
higgs1M = cudf.read_csv('./datasets/higgs1M.csv').iloc[:,1:30].astype('float32')
...
pred = cu_rf.predict(higgs1, predict_model='GPU')
end = (time.time() - start_time)*1000
print(end)


start_time = time.time()
pred = cu_rf.predict(higgs100, predict_model='GPU'))
end = (time.time() - start_time)*1000
print(end)

start_time = time.time()
pred = cu_rf.predict(higgs1K, predict_model='GPU'))
end = (time.time() - start_time)*1000
print(end)

start_time = time.time()
pred = cu_rf.predict(higgs10K, predict_model='GPU'))
end = (time.time() - start_time)*1000
print(end)

start_time = time.time()
pred = cu_rf.predict(higgs100K, predict_model='GPU'))
end = (time.time() - start_time)*1000
print(end)

start_time = time.time()
pred = cu_rf.predict(higgs1M, predict_model='GPU'))
end = (time.time() - start_time)*1000
print(end)
